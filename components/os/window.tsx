...
export function Window({ windowState }: { windowState: WindowState }) {
  const { id, title, isOpen, isMinimized, isMaximized, zIndex, position, size } = windowState;
  ...
  // Pointer-events drag (disabled when maximized)
  ...
  const onPointerMove = (e: React.PointerEvent<HTMLDivElement>) => {
    ...
    const wh = el ? el.offsetHeight : size.height;
  ...
  // Maximized: full viewport minus taskbar
